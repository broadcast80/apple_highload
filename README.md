...
|Song| MongoDB + S3 | id , name - при поиске пользователем трека по названию|
...
## 9. Схема проекта
![aoplokjsdf](https://github.com/user-attachments/assets/64034b66-3c1e-4d5a-88ef-0e1c2ca2d756)
