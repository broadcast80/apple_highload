...
|Таблица |СУБД |Мотивация |
| ------------- |-------------|-------------|
|Session| Redis| Для данной таблицы необходима высокая скорость, поэтому выбран Redis |
|User| Postgresql | |
|Song| Postgresql | |
...
|S3|Обьектное хранилище|Используем для хранения аватарок|
