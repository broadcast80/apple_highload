...
| ------------- |-------------|-------------|-------------|-------------|
|Регистрация| 16.71 тыс| 0.1932 | | |
|Авторизация| 6.6 млн| 76.3583 | | |
|Создание плейлистов|185.7 тыс| 2,1490 | | |
|Добавление в плейлист|742,8 тыс| 8.5930 | | |
|Открытие страницы исполнителя|15.4 млн| 171.1111 | | |
